...
<?php echo $this->Form->create('BookMaster'); ?>
	<?php
		...
		echo $this->Form->input('color_id', array('type' => 'select', 'div' => false, 'label' => 'シールの色', 'options' => $colors, 'empty' => '未選択', 'id' => 't1', 'name' => 't1', 'onMouseOut' => 'color(1)'));
		echo '&nbsp;';
		echo $this->Form->input('color_id_2', array('type' => 'select', 'div' => false, 'label' => false, 'options' => $colors, 'empty' => '未選択', 'id' => 't2', 'name' => 't2', 'onMouseOut' => 'color()'));
		echo '</div>';
